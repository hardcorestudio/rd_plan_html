'use strict';
angular.module('sbAdminApp').controller('LabEp2ListCtrl', ['$scope','Init','Modal','$stateParams','$rootScope','localStorageService','$state','CheckBrowser','$location', '$interval','CheckParam',function ($scope,Init,Modal,$stateParams,$rootScope,localStorageService,$state,CheckBrowser,$location,$interval,CheckParam) {
    CheckBrowser.check();
    ...
    var table = $('#planTable').DataTable({
        ...
        ajax:function(data, callback, settings){
            ...
            Init.iwbhttp('/admin/labEp2List', $scope.param, function(data,header,config,status){
                var returnData = {};
                if(data.resFlag == 0){
